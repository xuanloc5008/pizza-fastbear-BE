...
let MenuService = class MenuService {
    ...
    async addDishes(body) {
        ...
        await this.dbService.query('INSERT INTO Dishes (id, price, description, name, recipes) VALUES (NEWID(), @p1, @p2, @p3, @p4)', [
    ...
    async updateDishesbyID(id) {
        const update = this.dbService.query('SELECT * FROM Dishes WHERE id = @p1', [{ name: 'p1', value: id }]);
    }
};
